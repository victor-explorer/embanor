...
<main id="page-home">
  <!-- Section - Banner Home -->
  <?php if (get_field('acf_home_banner')) : ?>
    <section id="banner" style="background-image: url('<?php the_field('acf_home_banner'); ?>');">
    <?php else : ?>
      <section id="banner">
      <?php endif; ?>
      <div class="container">
      ...
      <section class="container-fluid">
        <div class="row hero-wrapper">
          ...
          <div class="col-lg order-last order-lg-first hero-image">
            <img src="<?php the_field('acf_home_imagem_projetos'); ?>" alt="Imagem" class="responsive-image">
          </div>
