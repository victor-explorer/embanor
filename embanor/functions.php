...
function embanor_load_scripts()
{
  ...
  wp_enqueue_script('jquery-lib', 'https://code.jquery.com/jquery-3.7.0.js', array(), '3.7.0', false);
  wp_enqueue_script('jquery-migrate', 'https://code.jquery.com/jquery-migrate-3.4.1.js', array(), '3.4.1', false);
  ...
  wp_enqueue_script('embanor-slick-lib', get_template_directory_uri() . '/assets/lib/slick/js/slick.min.js', array('jquery-lib'), '1.8.0', true);
  wp_enqueue_script('embanor-slick', get_template_directory_uri() . '/assets/scripts/slick.js', array('jquery-lib'), '1.0');
