...
<main id="page-contact">
  ...
  <section class="page-banner">
    <div class="container">
      <h1 class="banner-heading">Fale conosco</h1>
    </div>
  </section>
  <!-- End Section - Banner -->
  ...
  <section class="wrapper d-flex justify-content-center">
    <div class="container text-center">
      <h2 class="section-heading"><span>ONDE ESTAMOS</span></h2>
      <p>Estamos em localização estratégica, próxima a grandes rodovias do país, para levar nossas soluções até você de forma mais ágil, rápida e segura.</p>
    </div>
  </section>
